...
In practice actually just initialize a new flash object and then use the flash.fix.loadings and flash.backfit to initialize with binary loadings
...
sometimes gives weird error when all the standard deviations are zero
